# Zebrafish Genomic Safe Harbor Sites Identification 

Welcome to the **Zebrafish Genomic Safe Harbor Sites Identification**!  
This challenge is to identify potential **genomic safe harbor (GSH) sites** in the **zebrafish genome** using an **integrative omics approach**.
